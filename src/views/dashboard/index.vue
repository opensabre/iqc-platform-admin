...
<template>
  <div class="dashboard-page">
    ...
    <a-card :bordered="false" style="margin-bottom: 16px"><a-form layout="inline"><a-form-item label="统计开始"><a-date-picker v-model:value="fromDate" show-time format="YYYY-MM-DD HH:mm:ss" value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择开始时间" /></a-form-item><a-form-item label="统计结束"><a-date-picker v-model:value="toDate" show-time format="YYYY-MM-DD HH:mm:ss" value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择结束时间" /></a-form-item><a-form-item><a-button type="primary" @click="refreshDashboard">应用时间范围</a-button><a-button style="margin-left: 8px" @click="fromDate = ''; toDate = ''; refreshDashboard()">重置</a-button></a-form-item></a-form></a-card>
