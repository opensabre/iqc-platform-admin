      ...
      <a-col :xs="24" :lg="16">
        <a-card v-if="can('iqc:conversation:upload')" title="文本批量入库" :bordered="false">
          ...
          <a-form layout="vertical" class="metadata-form">
            ...
            <a-row :gutter="12"><a-col :xs="24" :md="12"><a-form-item label="会话开始时间"><a-date-picker v-model:value="metadata.startedTime" show-time value-format="YYYY-MM-DDTHH:mm:ss" style="width:100%" /></a-form-item></a-col><a-col :xs="24" :md="12"><a-form-item label="会话结束时间"><a-date-picker v-model:value="metadata.endedTime" show-time value-format="YYYY-MM-DDTHH:mm:ss" style="width:100%" /></a-form-item></a-col></a-row>
          </a-form>
          <a-tabs>
