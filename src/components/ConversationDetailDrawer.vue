    ...
    <a-spin :spinning="loading">
      <template v-if="detail">
        <a-descriptions size="small" :column="2" bordered class="detail-meta">
          <a-descriptions-item label="会话 ID" :span="2"><a-typography-text copyable>{{ detail.conversation.id }}</a-typography-text></a-descriptions-item>
